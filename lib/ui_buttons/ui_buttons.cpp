...
// Reads the state of the UI buttons and updates the UI_input struct accordingly.
// Parameters:
// - UI_input: a pointer to the UI_input_t struct that will be updated with the current state of the UI buttons.
// Returns: void
void _read_ui_buttons(UI_input_t* UI_input)
